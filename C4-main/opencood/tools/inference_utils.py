...
def inference_intermediate_fusion(batch_data, model, dataset):
    """
      ...
      The outer inference flow is the same as early fusion:
      one forward pass on batch_data['ego']. The actual intermediate
      fusion happens inside the dataset/model contract.
    """
